        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Where passion for beauty meets exceptional target, We have been boosting confidence since our inception. Our dedicated team of professionals is committed to delivering personalized services that cater to your unique style and needs.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
            ...
            <div className="flex flex-col justify-center">
              ...
              <div className="space-y-4 text-muted-foreground">
                ...
                <p>
                  Our team of expert brings together decades of combined experience, staying ahead of trends while mastering timeless techniques. We believe that every client deserves personalized attention and a look that reflects their individuality.
                </p>
                <p>
                  In Sisters Salon, we not only just style hair – but also we create experiences, build strong and unique relationships and foster a community of beauty enthusiasts. Join us on this journey and discover the true meaning of luxury hair care.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
            <Card className="border-none shadow-soft">
              <CardContent className="pt-8">
                <h3 className="text-2xl font-serif font-bold mb-4 text-primary">Our Daily Mission</h3>
          ...
          {/* Values */}
          <div className="mb-20">
            <h2 className="text-3xl font-serif font-bold text-center mb-12">Our daily Values</h2>
          ...
          <Card className="border-none shadow-soft max-w-2xl mx-auto">
            <CardContent className="pt-8">
              <h3 className="text-2xl font-serif font-bold text-center mb-6">Opening time</h3>
