          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
            ...
            <div className="flex flex-col justify-center">
              ...
              <div className="space-y-4 text-muted-foreground">
                ...
                <p>
                  At Luxe Salon, we don't just style hair – we create experiences, build strong relationships, and help our clients express their unique beauty.
                </p>
              </div>
            </div>
          </div>
          ...
          <Card className="border-none shadow-soft max-w-2xl mx-auto">
            <CardContent className="pt-8">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between items-center py-2 border-b border-border">
                  <span className="font-medium">Saturda</span>
