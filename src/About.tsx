          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
            ...
            <div className="flex flex-col justify-center">
              ...
              <div className="space-y-4 text-muted-foreground">
                ...
                <p>
                  At Sisters Salon, we don't just style hair – we create experiences, build strong relationships, and help our clients express their individuality through their look
                </p>
              </div>
            </div>
          </div>
