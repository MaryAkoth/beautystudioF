      ...
      <div className="pt-32 pb-20">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-16">
            <h1 className="text-5xl font-serif font-bold mb-6">About Luxe Salon</h1>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Where passion for beauty meets exceptional craftsmanship. We've been transforming looks and boosting confidence for over a decade of years.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
            ...
            <div className="flex flex-col justify-center">
              ...
              <div className="space-y-4 text-muted-foreground">
                <p>
                  Founded in 2014, Luxe Salon began with a simple vision: to create a space where artistry and luxury come together to deliver an unparalleled hair styling experience.
                </p>
                <p>
                ...
                <p>
                  At Luxe Salon, we don't just style hair – we create experiences, build relationships, and help our clients express their unique beauty.
                </p>
              </div>
            </div>
          </div>
            ...
            <Card className="border-none shadow-soft">
              <CardContent className="pt-8">
                ...
                <p className="text-muted-foreground">
                  To provide exceptional hair care services that enhance natural beauty, boost confidence, and create lasting impressions. We're committed to using premium products and staying at the forefront of industry innovations.
                </p>
              </CardContent>
            </Card>
            <Card className="border-none shadow-soft">
