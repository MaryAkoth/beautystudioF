          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
            ...
            <div className="flex flex-col justify-center">
              ...
              <div className="space-y-4 text-muted-foreground">
                <p>
                  Founded in 2022, the Sal began with a simple vision: to create a space where artistry and luxury come together to deliver an unparalleled hair styling experience
                </p>
                <p>
