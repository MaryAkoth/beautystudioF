          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
            ...
            <div className="flex flex-col justify-center">
              ...
              <div className="space-y-4 text-muted-foreground">
                ...
                <p>
                  Our team of expert styl brings together decades of combined experience, staying ahead of trends while mastering timeless techniques. We believe that every client deserves personalized attention and a look that reflects their individuality.
                </p>
                <p>
